        ...
        extends ScrollBarUI implements LayoutManager, SwingConstants
{
    ...
    static void loadActionMap(CustomLazyActionMap map) {
    ...
    protected void installKeyboardActions(){
        CustomLazyActionMap.Companion.installLazyActionMap(scrollbar, javax.swing.plaf.basic.BasicScrollBarUI.class,
                "ScrollBar.actionMap");
