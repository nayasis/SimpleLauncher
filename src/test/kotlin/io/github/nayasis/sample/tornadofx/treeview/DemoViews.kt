package io.github.nayasis.sample.tornadofx.treeview
    ...
    init {
        with(root) {
            ...
            vbox {
                ...
                val departments: List<Department> = persons.distinctBy { it.department }.map { Department(it.department) }
