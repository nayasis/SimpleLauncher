...
import com.nayasis.simplelauncher.library.mslinks.exception.UnsupportedCLSIDException;
...
//		System.out.printf( "pos :  %d, item id : %d\n", pos, type );
		
		if (type == TYPE_DRIVE) { // 47
			setName(br.readString(22));
			br.seek(pos + 23 - br.getPosition());
		} else if (type == TYPE_FILE || type == TYPE_DIRECTORY ) { //50, 49
			br.read(); // unknown
